...
4. In Supabase SQL editor, run `UPDATE documents SET status = 'processing' WHERE status = 'pending' LIMIT 1` -- the UI updates the badge to "Processing" without page refresh
