...
"12. Credit/return lines with negative amounts: set is_credit=true. These are legitimate and should be preserved, not treated as errors."
  ...
  <verify>
Read prompt.ts and verify:
- JSON schema includes line_type, discount_applies_to, is_credit, pricing_flag fields
- Top-level schema includes quote_discount_pct, quote_discount_amount
- "Line Item Classification Rules" section exists with all 5 types defined
- "Discount Attribution Rules" section exists with 4 scenarios
- "Edge Case Handling" section exists with all 6 edge cases
- Rules 7, 11, and 12 updated/added
  </verify>
